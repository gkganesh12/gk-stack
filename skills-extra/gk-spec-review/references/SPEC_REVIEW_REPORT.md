...
Output format template for gk-spec-review Step 7.
Save completed report to gk/spec-reviews/[YYYY-MM-DD]-[trigger].md
...
- [x] AGENT_ARCH.md
- [x] gk/SPEC.md
- [x] gk/ARCHITECTURE.md
- [ ] gk/features/.../FEATURE_SPEC.md — [not present / audited]
