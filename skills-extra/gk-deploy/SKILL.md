...
name: gk-deploy
description: >-
  Prepares a gk-* project for deployment — detects the stack, patches source
...
**Regenerate portal if gk-handoff was run.**
If `gk/handoff/` exists, remind the user to regenerate the handoff portal
