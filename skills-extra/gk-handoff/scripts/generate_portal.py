...
Usage:
  ...
  If no path given, searches for the most recent gk/handoff/* folder.
"""
...
def find_handoff_folder(given_path=None):
    ...
    # Search from cwd upward for gk/handoff/
    cwd = Path.cwd()
    for root in [cwd, *cwd.parents]:
        handoff_root = root / "gk" / "handoff"
    ...
    print("ERROR: No gk/handoff/ folder found. Run from inside a gk-* project.")
    sys.exit(1)
