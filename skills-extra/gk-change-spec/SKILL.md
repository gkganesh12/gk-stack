...
2. `gk/ARCHITECTURE.md` *(if exists)* — established patterns and principles
3. `gk/SPEC.md` — what is currently in scope
4. `gk/SPEC_INDEX.md` — feature list and state
5. `gk/TASKS.md` — active work, done vs pending
6. `gk/PLAN.md` — current architecture
7. `gk/CODEBASE.md` — what has actually been built
...
If gk/PLAN.md exists and has a Section 6 feature map — run this check:
...
## Step 5 — Update gk/SPEC.md + gk/SPEC_INDEX.md
...
## Step 7 — Update gk/ARCHITECTURE.md *(if affected)*
...
## Step 8 — Update gk/PLAN.md *(if affected)*
...
## Step 11 — Update gk/CODEBASE.md *(only if change affects built structure)*
...
Add to `gk/backlog/[YYYY-MM-DD]-[feature-slug].md`:
...
1. Read gk/backlog/[date-slug].md
2. Run gk-add-feature to generate the full feature kit
...
**Your task list is updated** — open gk/TASKS.md to see the new sequence.
