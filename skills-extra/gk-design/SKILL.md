...
description: >-
  ...
  gk projects. Use when the goal is visual — aesthetics, layout, feel,
...
Handles all visual styling for a gk project.
...
- **gk agent** — spec compliance, data flow, logic, tests, docs
- **gk-design** — aesthetics, layout, feel, interactions, visual polish
...
1. `gk/CODEBASE.md` — stack, component library, file paths
2. `gk/SPEC.md` — UI specification, screens, components
3. `gk/DESIGN_SYSTEM.md` — existing tokens
...
> gk-design produces production files, not wireframes.
...
Update `gk/DESIGN_SYSTEM.md` with the design contract as the direction section.
Update `gk/TASKS.md` with what was built.
...
✅ Design complete — [scope]
   ...
   Contract: gk/design/CONTRACT.md
```
