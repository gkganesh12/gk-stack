...
Read by gk-design during Step 3 when no DESIGN.md exists.
Read by gk-design-md when generating a new DESIGN.md to validate quality.
...
When gk-design reads a DESIGN.md, these patterns provide the interpretive layer.
...
When gk-design has no DESIGN.md, these patterns are the fallback —
