...
The canonical BRIEF.md template for gk-* projects.
Used by gk-brainstorm to generate BRIEF.md.
...
Downstream consumers and what they read:
  ...
  gk-agent:   problem, user, constraints, integrations (if agentic project)
